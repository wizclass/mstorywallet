...
<body class="bf-login">
    ...
    <div class="find_wrap container mt-3">
        ...
        <div class="hp_form mt-4" id="hp_form">
            ...
            <input type="text" id="mb_email" class="b_radius_10 mb-2 border" placeholder="이메일 입력">
...
<script>
    ...
    $('#hp_button').click(function() {
        ...
        if ($('#mb_name').val() == "" || $('#mb_email').val() == "") {
            dialogModal('','실명 또는 이메일을 입력해주세요.','find_warning');
            return;
        }
        ...
        $.ajax({
            ...
            complete: function(res) {
                ...
                if (check) {
                    ...
                    dialogModal('','입력하신 이메일로 인증번호가 전송되었습니다. 이메일을 확인해주세요.','find_success');
                    let count;
                    ...
                    $('#auth_number_confirm').click(function(){
                        ...
                        if(auth_number.length == 6){
                            ...
                            $.ajax({
                                url:'/util/find_id_by_email_proc.php',
                                type: "POST",
                                dataType: "json",
                                async: false,
                                cache: false,
