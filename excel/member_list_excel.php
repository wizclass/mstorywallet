...
//member_list.php 에서 회원엑셀다운로드 버튼 클릭시 넘어오는 데이터
$sql_common = $_POST['sql_common'];
$sql_search = $_POST['sql_search'];
...
//엑셀 파일명 및 다운로드
$objPHPExcel->setActiveSheetIndex(0);
$filename = iconv("UTF-8", "EUC-KR", "회원엑셀파일");
